//Leetcode
//3373. Maximize the Number of Target Nodes After Connecting Trees II - BFS
...
public class MaximizeTheNumberOfTargetNodesAfterConnectingTreesII_2 {
    ...
    static int evenA, oddA, evenB, oddB;
    ...
    static List<List<Integer>> buildList(int[][] edges) {
    ...
    static void dfsColor(List<List<Integer>> adj, int u, int parent, int[] color, boolean isA) {
        if (color[u] == 0) {
            if (isA)
                evenA++;
            else
