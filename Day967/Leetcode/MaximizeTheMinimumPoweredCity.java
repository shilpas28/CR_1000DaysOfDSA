...
public class MaximizeTheMinimumPoweredCity {
    ...
    static long[] diffArray; // difference array for efficient range updates
    static long[] cityPower; // current power in each city
    static int n;
    ...
    static boolean canAchieve(long target, int r, long kAvailable) {
