//Leetcode
//726. Number of Atoms
//Time complexity: O(n^2), since at the end we use sorting (n log n), but in the loop we constantly readding characters from hashmap to 
//hashmap and in the worst case we will do this n // 2 times with every hashmap containing up to n - (number of brackets so in total this 
//result in O(n^2)
