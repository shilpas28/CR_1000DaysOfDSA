//Leetcode
//338. Counting Bits - Using DP (Memoization/Top down)
//Time complexity: O(N)
//Space complexity: O(N)

import java.util.Arrays;

public class CountingBits_4 {
    ...
    public static int solve(int n, int memo[]) {
        ...
        if (memo[n] != 0)
            return memo[n]; // if memo of n answer is already available we will re-use it & not go further
                            // for calculation
