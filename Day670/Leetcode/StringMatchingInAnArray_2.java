...
public class StringMatchingInAnArray_2 {
    ...
    // Function to compute the LPS (Longest Prefix Suffix) array for the substring
    // 'sub'.
    static int[] computeLPSArray(String sub) {
    ...
    static boolean isSubstringOf(String sub, String main, int[] lps) {
        int mainIndex = 0;
        int subIndex = 0;
