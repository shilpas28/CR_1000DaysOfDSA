//Leetcode
//2342. Max Sum of a Pair With Equal Sum of Digits -  Store Maximum Value
//Time complexity: O(nlogm) 
//Space complexity: O(logm)

public class MaxSumOfAPairWithEqualSumOfDigits_3 {
    ...
    public static int maximumSum(int[] nums) {
        ...
        for (int element : nums) {
            ...
            // Update the mapping to store the larger of the current or previous element for
            // this digit sum
