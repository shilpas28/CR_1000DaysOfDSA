//Leetcode
//862. Shortest Subarray with Sum at Least K - Sliding Window + (increasing) Monotonic deque
//Time complexity: O(N)
...
public class ShortestSubarrayWithSumAtLeastK_3 {

    static class Pair<K, V> { // Helper class store pairs values
        private final K key;
