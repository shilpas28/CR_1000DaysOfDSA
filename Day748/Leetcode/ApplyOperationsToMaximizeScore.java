//Leetcode
//2818. Apply Operations to Maximize Score - Monotonic Stack & Priority Queue
...
public class ApplyOperationsToMaximizeScore {
    ...
    public static int maximumScore(List<Integer> nums, int k) {
        ...
        for (int index = 0; index < n; index++) {
            // While the stack is not empty and the current prime score is greater than the
            // stack's top
            ...
            // If the stack is not empty, set the previous dominant element for the current
            // index
