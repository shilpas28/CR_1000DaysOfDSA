//Leetcode
//1368. Minimum Cost to Make at Least One Valid Path in a Grid - 0-1 Breadth-First Search
...
public class MinimumCostToMakeAtLeastOneValidPathInAGrid_3 {
    ...
    static boolean isValid(int row, int col, int numRows, int numCols) {
