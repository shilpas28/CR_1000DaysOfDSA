//Leetcode
//1220. Count Vowels Permutation - Tabulation Approach - Space Optimized
//Time complexity: O(6 * 5 * N)
//Space complexity: O(6) (Approximately constant space)

package Leetcode;

import java.util.Arrays;

public class CountVowelsPermutation_4 {
