//Leetcode
//689. Maximum Sum of 3 Non-Overlapping Subarrays - Three Pointers
//Time complexity: O(n)
//Space complexity: O(n)

import java.util.Arrays;

public class MaximumSumOf3NonOverlappingSubarrays_3 {
    ...
    public static int[] maxSumOfThreeSubarrays(int[] nums, int k) {
        ...
        // Iterate over the middle subarray and calculate the total sum for all valid
        // combinations
