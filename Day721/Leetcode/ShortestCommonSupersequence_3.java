//Leetcode
//1092. Shortest Common Supersequence - Bottom-Up Dynamic Programming
//Time complexity: O(n*m*(n+m))
//Space complexity: O(m*(n+m))

public class ShortestCommonSupersequence_3 {
    ...
    public static String shortestCommonSupersequence(String str1, String str2) {
        ...
        // Initialize the first row (when str1 is empty, the supersequence is str2's
        // prefix)
        ...
        for (int row = 1; row <= str1Length; row++) {
            // Initialize the first column (when str2 is empty, the supersequence is str1's
            // prefix)
