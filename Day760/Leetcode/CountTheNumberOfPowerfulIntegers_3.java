//Leetcode
//2999. Count the Number of Powerful Integers - Combinatorial mathematics 
//Time complexity: O(log(finish))
//Space complexity: O(log(finish))

public class CountTheNumberOfPowerfulIntegers_3 {
    ...
    static long calculate(String x, String s, int limit) {
