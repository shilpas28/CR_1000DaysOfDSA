//Leetcode
//2081. Sum of k-Mirror Numbers - Generate all k-based palindromes
...
public class SumOfKMirrorNumbers_2 {
    ...
    static long constructMirrorNumbers(int len, int k, int n, List<String> list1, List<String> list2) {
        ...
        for (int i = 0; i < k && n > 0; i++) {
            // To construct numbers of length len, use list1 if len is even and list2 if len
            // is odd
