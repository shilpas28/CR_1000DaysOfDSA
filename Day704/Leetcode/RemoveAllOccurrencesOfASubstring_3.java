//Leetcode
//1910. Remove All Occurrences of a Substring - Knuth-Morris-Pratt (KMP) Algorithm
//Time complexity: O(n+m)
//Space complexity: O(n+m) 

import java.util.Stack;

public class RemoveAllOccurrencesOfASubstring_3 {
    ...
    static int[] computeLongestPrefixSuffix(String pattern) {
