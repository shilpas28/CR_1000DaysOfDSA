//Leetcode
//1432. Max Difference You Can Get From Changing an Integer - Greedy 
//Time complexity: O(log(num))
//Space complexity: O(1) 

public class MaxDifferenceYouCanGetFromChangingAnInteger_2 {
    ...
    public static int maxDiff(int num) {
        ...
        // Or find a high-order digit that is not equal to the highest digit and replace
        // it with 0.
    ...
    public static void replace(StringBuffer s, char x, char y) {
        int length = s.length();
