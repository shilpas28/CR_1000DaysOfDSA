//Leetcode
//3108. Minimum Cost Walk in Weighted Graph - Breadth-First Search (BFS) 
...
public class MinimumCostWalkInWeightedGraph_2 {
    ...
    public static int[] minimumCost(int n, int[][] edges, int[][] query) {
        ...
        int componentId = 0;
        // Perform BFS for each unvisited node to identify components and calculate
        // their costs
    ...
    static int getComponentCost(
        ...
        // Initialize the component cost to the number that has only 1s in its binary
        // representation
        ...
        while (!nodesQueue.isEmpty()) {
            ...
            for (int[] neighbor : adjList.get(node)) {
                ...
                // If the neighbor hasn't been visited, mark it as visited and add it to the
                // queue
