//Leetcode
//2493. Divide Nodes Into the Maximum Number of Groups - Graph Coloring + Longest Shortest Path
...
public class DivideNodesIntoTheMaximumNumberOfGroups {
    ...
    static int getLongestShortestPath(
        ArrayList<ArrayList<Integer>> adjList,
        int srcNode,
        int n
    ) {
    ...
    static int getNumberOfGroupsForComponent(
        ArrayList<ArrayList<Integer>> adjList,
        int node,
        int[] distances,
        boolean[] visited
