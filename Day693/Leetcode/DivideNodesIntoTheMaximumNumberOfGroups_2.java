//Leetcode
//2493. Divide Nodes Into the Maximum Number of Groups - BFS + Union-Find 
...
public class DivideNodesIntoTheMaximumNumberOfGroups_2 {
    ...
    static void union(int node1, int node2, int[] parent, int[] depth) {
