//Leetcode
//1028. Recover a Tree From Preorder Traversal - Optimized Iterative Approach with Stack (No String Manipulation)
//Time complexity: O(n)
//Space complexity: O(n)

import java.util.Stack;

public class RecoverATreeFromPreorderTraversal_4 {
