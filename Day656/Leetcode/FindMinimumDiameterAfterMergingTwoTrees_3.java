//Leetcode
//3203. Find Minimum Diameter After Merging Two Trees - Topological Sorting
...
public class FindMinimumDiameterAfterMergingTwoTrees_3 {
    ...
    static List<List<Integer>> buildAdjList(int size, int[][] edges) {
    ...
    static int findDiameter(int n, List<List<Integer>> adjList) {
        Queue<Integer> leavesQueue = new LinkedList<>();
        int[] degrees = new int[n];
        // Initialize the degree of each node and add leaves (nodes with degree 1) to
        // the queue
        ...
        // If exactly two nodes remain, return the diameter as twice the number of
        // layers of leaves removed + 1
        if (remainingNodes == 2)
