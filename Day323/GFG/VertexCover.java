...
public class VertexCover {
    ...
    static int vertexCoverHelper(ArrayList<ArrayList<Integer>> adj, int n, int m) {
        int low = 1, high = n;
        while (high > low) {
            int mid = (low + high) >> 1;
    ...
    static boolean checkCover(int n, int k, int m, ArrayList<ArrayList<Integer>> adj) {
        int set = (1 << k) - 1;
        int limit = (1 << n);
