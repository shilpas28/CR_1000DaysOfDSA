//Leetcode
//2593. Find Score of an Array After Marking All Elements - Stack
//Time complexity: O(N)
...
public class FindScoreOfAnArrayAfterMarkingAllElements_3 {
    ...
    public static long findScore(int[] nums) {
        ...
        for (int i = 0; i < n; i++) {
            // If queue is not empty and the current number is greater than or equal to the
            // last in queue
