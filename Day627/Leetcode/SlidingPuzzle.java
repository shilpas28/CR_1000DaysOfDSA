...
// E = 3 * V, because there can be a maximum of 3 edges from each vertex.
// Total TC = O((MN)! + 3*(MN)!) = O((MN)!) = O(4 * 6!)
//Space complexity: O((MN)!) to save each state in begin, end and visited collections = O(6!)
...
public class SlidingPuzzle {
    ...
    static final int FINAL_STATE = 0b001010011100101000;
    ...
    static final int[][] DIRS = { { 1, 3 }, { 0, 2, 4 }, { 1, 5 }, { 0, 4 }, { 1, 3, 5 }, { 2, 4 } };
    ...
    static int swap(int state, int zeroIdx, int destIdx) {
